...
def score(evidence: list[EvidenceRecord], claims: list[ClaimRecord] | None = None) -> float:
    """Return a 0-100 operational score from flight and operations evidence only."""
    return category_evidence_score(evidence, "operational")
